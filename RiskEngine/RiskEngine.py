def yes_no_converter(result_yes_no):
    mapping_yes_no = {
        "Yes": True,
        "No": False    }
    result_true_false = mapping_yes_no[result_yes_no]
    return result_true_false

def family_HT_result_converter(result_family_HT):
    mapping_family_HT = {        
        "ไม่มีใครเป็น": 0,
        "เป็น 1 คน": 1,
        "เป็นทั้งพ่อทั้งแม่": 2}
    result_family_number = mapping_family_HT[result_family_HT]
    return result_family_number    
