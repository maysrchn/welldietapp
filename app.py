...
# ศึกษาปุ่มที่กดแล้วค่าเป็น true อันใดอันหนึ่งค้าง
# if st.button("View Result") == False:
#     st.button("Back")== True
...
def viewresult_button():
    def onclick():
        st.session_state.viewresult_button=st.session_state.viewresult_button_input
        if st.session_state.viewresult_button_input==True:
            viewresult()
            back_button()
...
def back_button():
    def onclick():
        st.session_state.back_button=st.session_state.back_button_input
        if st.session_state.back_button_input==True:
            st.title('Well Diet')
...
def main():
    if (st.session_state.viewresult_button or st.session_state.back_button )is True:
        st.empty()
    else:
        st.title('Well Diet')
        st.subheader('NCDs Risk Detection and Lifestyle Modification Therapy')
...
# if assessment():
#     viewresult_button()
#     if st.session_state.viewresult_button is True:
#         viewresult()
# if viewresult():
#     back_button()
#     if st.session_state.back_button is True:
#         assessment()


# st.session_state.viewresult_button=st.button("View Result")
